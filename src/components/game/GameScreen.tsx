...
function GameScreenInner({ onOpenSimulator }: GameScreenProps) {
  ...
  const { handleDebugAddItems, handleDebugAddItemList } = useDebugContext();
  ...
  return (
    <div className="flex flex-col h-screen bg-stone-950 overflow-hidden relative dark-game-shell">
      ...
      <DebugPanel
        onAddItems={(items) => {
          // add the exact items generated by panel instead of recreating by slot/quality
          handleDebugAddItemList(items);
        }}
