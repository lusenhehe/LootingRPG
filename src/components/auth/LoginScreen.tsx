...
export function LoginScreen({ profiles, onLogin, onCreate, onDelete }: LoginScreenProps) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 md:p-8 relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-radial from-violet-500/5 via-transparent to-transparent rounded-full" />
      ...
      >
        <section className="bg-gradient-to-br from-game-card/90 to-game-card/60 backdrop-blur-sm border border-game-border/50 rounded-2xl p-6 shadow-2xl shadow-purple-500/10 relative overflow-hidden">
                ...
                >
                  <button onClick={() => onLogin(profile.id)} className="text-left flex-1">
                    <div className="flex items-center gap-2">
                      <div className="w-8 h-8 bg-gradient-to-br from-violet-600/30 to-purple-600/30 rounded-lg flex items-center justify-center">
                  ...
                  <div className="flex items-center gap-2 ml-2">
                    <motion.button 
                      ...
                      className="px-2.5 py-1.5 rounded-lg bg-violet-600/20 text-violet-400 hover:bg-violet-500 hover:text-white text-xs font-bold transition-all cursor-pointer"
                    >
                      <LogIn size={12} />
                    </motion.button>
                    <motion.button 
        ...
        <motion.section 
          ...
          className="bg-gradient-to-br from-game-card/90 to-game-card/60 backdrop-blur-sm border border-game-border/50 rounded-2xl p-6 shadow-2xl shadow-purple-500/10 relative overflow-hidden"
        >
          <div className="absolute inset-0 bg-gradient-to-br from-purple-500/5 to-rose-500/5" />
          ...
          <div className="relative z-10">
            ...
            <div className="space-y-3">
              ...
              <motion.button
                ...
                className="w-full py-3 rounded-xl bg-gradient-to-r from-violet-600 to-purple-600 text-white font-bold hover:brightness-110 hover:shadow-lg hover:shadow-purple-500/30 transition-all flex items-center justify-center gap-2 cursor-pointer relative overflow-hidden group"
              >
