...
- `src/logic/inventory/actions.ts`、`src/logic/inventory.ts` -> `src/domains/inventory/services/*`
- `src/logic/inventory/autoSell.ts` -> `src/domains/inventory/services/autoSell.ts`
