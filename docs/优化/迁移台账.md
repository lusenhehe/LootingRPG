...
| MIG-003 | inventory | `src/logic/equipmentUtils.ts` | `src/domains/inventory/services/equipmentTotals.ts` | 迁移中 | Agent | 2026-03-20（计划） | build + check:orphan | 装备统计已迁入 domains，旧入口改兼容导出 |
| MIG-004 | inventory | `src/logic/enhancement.ts` | `src/domains/inventory/services/equipment.ts` | 迁移中 | Agent | 2026-03-20（计划） | build + check:orphan | enhancement 仍走旧入口，后续替换调用路径 |
