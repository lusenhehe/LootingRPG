...
| MIG-027 | inventory | `src/logic/inventory/actions.ts` | `src/domains/inventory/services/actions.ts` | 迁移中 | Agent | 2026-03-22（计划） | build + check:orphan | 已建立 domains 实现，旧入口改兼容导出 |
| MIG-028 | inventory | `src/logic/inventory/autoSell.ts` | `src/domains/inventory/services/autoSell.ts` | 迁移中 | Agent | 2026-03-22（计划） | build + check:orphan | 已建立 domains 实现，旧入口改兼容导出 |
| MIG-029 | inventory | `src/logic/inventory.ts` | `src/domains/inventory/services/quickSell.ts` | 迁移中 | Agent | 2026-03-22（计划） | build + check:orphan | 已建立 domains 实现，旧入口改兼容导出 |
...
| MIG-038 | app | `src/logic/gameState/index.ts` | `src/app/state/index.ts` | 迁移中 | Agent | 2026-03-29（计划） | build + check:orphan | 已建立 app/state 实现，旧入口改兼容导出 |
...
| MIG-040 | infra | `src/logic/i18n/labels.ts` | `src/infra/i18n/labels.ts` | 迁移中 | Agent | 2026-03-29（计划） | build + check:orphan | 已建立 infra 实现，旧入口改兼容导出 |
